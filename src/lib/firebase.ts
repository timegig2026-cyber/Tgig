...
import { initializeFirestore, doc, getDoc, setDoc, updateDoc, deleteDoc, collection, query, where, onSnapshot, serverTimestamp, addDoc, getDocFromServer, limit, arrayUnion } from 'firebase/firestore';
